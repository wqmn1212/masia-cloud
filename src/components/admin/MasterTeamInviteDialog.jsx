...
export default function MasterTeamInviteDialog({ tenantId }) {
  ...
  const [form, setForm] = useState({ email: '', account_label: '', team_role_id: '', send_password_setup: true });
  ...
  const invite = useMutation({
    ...
    onSuccess: (res) => {
      ...
      setOpen(false);
      setForm({ email: '', account_label: '', team_role_id: '', send_password_setup: true });
