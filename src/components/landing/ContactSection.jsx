        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-[30px] border-t border-landing-line pt-[22px] flex flex-col gap-3.5">
            <div>
              ...
              <div className="text-[15px] font-semibold mt-[3px] text-landing-ink">{tx(contact.hq, lang)}</div>
            </div>
            <div>
              <div className="text-xs font-bold text-landing-muted2 tracking-[.3px]">{tx(contact.szLabel, lang)}</div>
              <div className="text-[15px] font-semibold mt-[3px] text-landing-ink">{tx(contact.sz, lang)}</div>
            </div>
          </div>
        </div>
