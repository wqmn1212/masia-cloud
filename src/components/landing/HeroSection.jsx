...
export default function HeroSection({ lang }) {
  return (
    <section id="top" className="max-w-[1200px] mx-auto px-5 lg:px-8 pt-16 pb-16 lg:pt-24 lg:pb-[72px]">
      <div className="lm-hero-stack">
        <div className="flex-1 min-w-0">
          <div className="lm-hero-badge inline-flex items-center gap-2 px-3 py-1.5 bg-landing-tint border border-landing-tint-border rounded-full text-[12.5px] font-bold text-landing-brand tracking-[-0.2px]">
          ...
          <div className="lm-hero-actions flex flex-wrap gap-2.5 mt-8">
