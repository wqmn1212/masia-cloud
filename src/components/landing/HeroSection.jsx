...
export default function HeroSection({ lang }) {
  return (
    <section id="top" className="max-w-[1200px] mx-auto px-5 lg:px-8 pt-16 lg:pt-24 pb-16 lg:pb-[72px]">
      <div className="flex flex-col lg:flex-row gap-16 items-start">
        <div className="flex-1 min-w-0">
          ...
          <h1 className="mt-[22px] text-[38px] lg:text-[44px] xl:text-[56px] leading-[1.22] lg:leading-[1.16] tracking-[-1.4px] lg:tracking-[-1.7px] xl:tracking-[-2.2px] font-extrabold text-landing-ink [text-wrap:balance]">
