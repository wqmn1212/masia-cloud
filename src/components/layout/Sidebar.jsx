...
import {
  ...
  ShieldCheck, UserCog, BarChart3, KeyRound, Bot, FolderOpen, FileSignature, BookMarked, Boxes, Inbox, MessageCircle
} from 'lucide-react';
...
const navSectionDefs = [
  {
    ...
    items: [
      ...
      { path: '/chat-consultations', icon: MessageCircle, label: '실시간 상담' },
      ...
      { path: '/bom-extractor', icon: Boxes, label: 'STEP 도면 분석' },
      { path: '/financial-report', icon: BarChart3, label: '재무 리포트' },
      { path: '/task-board', icon: Kanban, labelKey: 'nav.taskboard' },
      { path: '/assistant', icon: Bot, label: 'AI 업무 비서' },
      { path: '/file-center', icon: FolderOpen, label: '파일 센터' },
